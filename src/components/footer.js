...
import { faGithub, faLinkedin, faTwitter, faInstagram, faFacebook, faTelegram } from '@fortawesome/free-brands-svg-icons'
...
export default function Footer() {
	...
	return (
		<footer style={footerStyle}>
			...
			<a href="https://t.me/rochimfn"><FontAwesomeIcon icon={faTelegram} size="2x" style={faTelegramStyle} /></a>
