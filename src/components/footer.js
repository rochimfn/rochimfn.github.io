...
export default function Footer() {
  ...
  const faTelegramStyle = { color: "#0088cc", marginRight: "10px" }
  ...
  return (
    <footer style={footerStyle}>
      <p>
        By <a href="http://rochimfn.github.io/contact/">Rochim</a>
      </p>

      <a href="mailto:rochim.noviyan@gmail.com">
        <FontAwesomeIcon icon={faEnvelope} size="2x" style={faEnvelopeStyle} />
      </a>
      <a href="https://t.me/rochimfn">
        <FontAwesomeIcon icon={faTelegram} size="2x" style={faTelegramStyle} />
      </a>
      <a href="https://github.com/rochimfn">
        <FontAwesomeIcon icon={faGithub} size="2x" style={faGithubStyle} />
      </a>
      <a href="https://www.linkedin.com/in/rochim-farul-noviyan-421292164">
        <FontAwesomeIcon icon={faLinkedin} size="2x" style={faLinkedinStyle} />
      </a>
      <a href="https://twitter.com/rochimfn">
        <FontAwesomeIcon icon={faTwitter} size="2x" style={faTwitterStyle} />
      </a>
      <a href="https://instagram.com/rochim.noviyan">
        <FontAwesomeIcon
          icon={faInstagram}
          size="2x"
          style={faInstagramStyle}
        />
      </a>
      <a href="https://www.facebook.com/rochim.farulnoviyan">
